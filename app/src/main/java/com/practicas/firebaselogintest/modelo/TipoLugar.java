package com.practicas.firebaselogintest.modelo;
...
TipoLugar {
    ...
    GASOLINERA ("Gasolinera", R.drawable.refugio),
    TIENDAMASCOTAS ("Tienda de Mascotas", R.drawable.tiendamascotas),
    REFUGIO("Refugio animal",R.drawable.refugio);
